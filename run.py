...
def print_model_params(model):
    ...
    for p in model.parameters():
        if p not in seen_params:
            ...
            total_params += num_el
            total_mem_bytes += num_el * p.element_size()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_path', type=str, default='E:\\Deep Learning\\Dataset\\time_series_datasets\\ETT-small', help='root path of the data file')
    ...
    parser.add_argument('--min_lr', type=float, default=1e-8, help='minimum learning rate for cosine annealing')
